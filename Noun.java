...
public class Noun extends partsOfSpeech {
    ...
    protected String singularGenitive;
    protected String gender;
    protected String english;

    private static final Pattern firstDeclension = Pattern.compile("(.*)ae$");
    private static final Pattern secondDeclension = Pattern.compile("(.*)i-$");
    ...
    public boolean test(String aspect, String answer)
  {
    ...
    public static int declension(Noun n)
    {
    ...
    protected static String declineFirst(Noun n, String nouncase)
    {
